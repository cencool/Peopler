...
<div class='row'>
	...
	<div class='col-xs-2'>
		<?= Html::a(Yii::t('app', 'Add Relation'), ['/my-db/add-relation', 'id' => $person->id], ['class' => $addRelationClass])  ?>
	</div>
</div>
<div class='row'>
	<?php
		...
		'columns' => [
			...
			[
				...
				'content' => function ($model) {
					return Html::a($model['relation_to_whom'], ['/my-db/view', 'id' => $model['to_whom_id']]);
				}
			],
		]
	]);
